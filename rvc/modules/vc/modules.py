...
class VC:
    ...
    def get_vc(self, model_path: str, *to_return_protect: int):
        logger.info("Get sid: " + model_path)
        ...
        person = model_path if os.path.exists(model_path) else f'{os.getenv("weight_root")}/{model_path}'
